...
#define mBoxBawah_0 26
#define mBoxBawah_1 28
#define mDepan_0 34
#define mDepan_1 44
#define mBelakang_0 30
#define mBelakang_1 32
...
bool stateGripperBox = 0;
bool stateGripperBoxMode = 0;
...
void initSolenoid() {
  ...
  pinMode(mBoxAtas_0, OUTPUT);
  pinMode(mBoxAtas_1, OUTPUT);
  pinMode(mBoxBawah_0, OUTPUT);
  pinMode(mBoxBawah_1, OUTPUT);
  digitalWrite(mBoxAtas_0, LOW);
  digitalWrite(mBoxAtas_1, LOW);
  digitalWrite(mBoxBawah_0, HIGH);
  digitalWrite(mBoxBawah_1, LOW);
}
    ...
    if (kontrolManual) {
      ...
      if (cmpSerial.available()) {
        ...
        if (IR64_manual == 'C') {
          ...
          //   stateGripperSph = 1;
          // }
          stateGripperBoxMode = !stateGripperBoxMode;

          if (stateGripperBoxMode) {
            digitalWrite(mBoxBawah_0, LOW);
            digitalWrite(mBoxBawah_1, HIGH);
          } else {
            digitalWrite(mBoxBawah_0, HIGH);
            digitalWrite(mBoxBawah_1, LOW);
          }
          stateGripperBox = true;
          lTimeGripperBox = millis();
        }
        if (IR64_manual == 'E') {
          if (_arm_box_top == 90) {
            _arm_box_top = 135;
      ...
      if (stateGripperBox && millis() - lTimeGripperBox >= 1000) {
        digitalWrite(mBoxBawah_0, LOW);
        digitalWrite(mBoxBawah_1, LOW);
      }
